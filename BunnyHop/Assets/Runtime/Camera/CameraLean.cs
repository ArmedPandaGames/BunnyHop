...
public class CameraLean : MonoBehaviour
{
    ...
    {
        var plannarAcceleration = Vector3.ProjectOnPlane(acceleration, up);
        var damping = plannarAcceleration.magnitude > _dampedAcceleration.magnitude
            ? attackDamping
            : decayDamping;
        ...
        //reset the rotation to that of its own parent
